    ...
    <div className="container-roc grid gap-14 py-16 lg:grid-cols-[1fr_1.1fr]">
      <div>
        ...
        <div className="mt-8 space-y-5 text-sm text-encre/80">
          <p className="flex items-center gap-3"><MapPin size={18} className="text-pinot" /> 25 rue de Mulhouse, 68000 Colmar</p>
          <p className="flex items-center gap-3"><Phone size={18} className="text-pinot" /> 03 89 00 00 00</p>
          <p className="flex items-center gap-3"><Mail size={18} className="text-pinot" /> contact@rocimmobilierservice.com</p>
          <p className="flex items-center gap-3"><Clock size={18} className="text-pinot" /> Lun–Ven 9h–18h30 · Sam 9h–12h30</p>
        </div>

        <div className="mt-10 aspect-video overflow-hidden rounded-sm border border-ligne">
          <iframe
            title="Localisation de l'agence ROC Immobilier à Colmar"
